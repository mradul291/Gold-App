// Till - Purity As Select Field Functionality.
...
//                     <td><input type="text" class="from-purity" placeholder="From" /></td>
//                     <td><input type="text" class="to-purity" placeholder="To" /></td>
...
// 		const purityOptions = purities.map((p) => `<option value="${p}">${p}</option>`).join("");
...
// Added Purity Select + Searchable
